(function(){
  ...
  function addControls(hiId,enId,mode){
    ...
    if(hiLabel){const b=makeButton('↔ Auto English',()=>sync(hiId,enId,mode,true));hiLabel.insertBefore(b,hi);}
    if(enLabel){const b=makeButton('↔ Auto Hindi',()=>sync(enId,hiId,mode,true));enLabel.insertBefore(b,en);}
